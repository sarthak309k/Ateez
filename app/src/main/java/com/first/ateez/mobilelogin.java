...
import com.first.ateez.databinding.ActivityMobileloginBinding;
        ...
        binding.idBtnGetOtp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtPhone.getText().toString())) {
                    ...
                    Toast.makeText(mobilelogin.this, "Please enter a valid phone number.", Toast.LENGTH_SHORT).show();
                } else {
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(mobilelogin.this, chat_activity.class);
                            startActivity(i);
                            finish();
                        } else {
                            // if the code is not correct then we are
                            // displaying an error message to the user.
                            Toast.makeText(mobilelogin.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
